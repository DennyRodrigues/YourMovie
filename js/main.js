...
function searchAnswer(searchQuery) {
  $.ajax(
    `https://api.themoviedb.org/3/search/movie?api_key=2c7a7142763b8809159d99fdf307fbb8&language=en-US&query=${searchQuery}&page=${page}&include_adult=false`
  )
    .then((response) => {
...
function popular_movies() {
  $.ajax(
    `https://api.themoviedb.org/3/movie/popular?api_key=2c7a7142763b8809159d99fdf307fbb8&language=en-US&page=${page}`
  )
    .then((response) => {
      totalPages = response.total_pages;
...
function showInformation() {
  ...
  $.when(
    $.ajax(
      `https://api.themoviedb.org/3/movie/${movieId}?api_key=2c7a7142763b8809159d99fdf307fbb8&language=en-US`
    ),
    $.ajax(
      `https://api.themoviedb.org/3/movie/${movieId}/credits?api_key=2c7a7142763b8809159d99fdf307fbb8&language=en-US`
    )
  )
